...
unset($__errorArgs, $__bag); ?>" required>
                        <option value="1" <?php echo e((old('role_id', $user->role_id) == 1 || strtolower($user->role->name ?? '') === 'admin') ? 'selected' : ''); ?>>Admin</option>
                        <option value="2" <?php echo e((old('role_id', $user->role_id) == 2 || strtolower($user->role->name ?? '') === 'kasir') ? 'selected' : ''); ?>>Kasir</option>
                    </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POSKEYLA\resources\views/users/edit.blade.php ENDPATH**/ ?>